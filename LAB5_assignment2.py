...
ar_CDR = df_CDR['In'].unique()
ar_CDR = ar_CDR.tolist()
...
#
user1 = df_CDR[(df_CDR.In==ar_CDR[0])]
...
df_CDR1 = pd.get_dummies(user1,columns=['DOW'])
...
df_CDR1 = df_CDR1[(df_CDR1.DOW_Sat == 1) | (df_CDR1.DOW_Sun == 1)  ]
df_CDR1 = df_CDR1[(df_CDR1.CallTime < "06:00:00") | (df_CDR1.CallTime > "22:00:00")  ]
df_CDR1.reset_index()
...
df_u1 = user1[['TowerLon', 'TowerLat']]

from sklearn.cluster import KMeans
kmeans = KMeans(n_clusters=1)
kmeans.fit(df_u1)

labels = kmeans.predict(df_u1)
centroids = kmeans.cluster_centers_
val = centroids[0].tolist()
...
ax.scatter(user1.TowerLon,user1.TowerLat, c='g', marker='o', alpha=0.2)
ax = fig.add_subplot(111)
ax.scatter(val[0],val[1], c='r', marker='o')
ax.set_title('Weekend Calls (<6am or >10p) with Centroid')
